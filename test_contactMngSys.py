...
@pytest.mark.parametrize("input_values, expected_output", [
    (["John Doe", "0554333786", "johndoe@gmail.com"], "Contact 'John Doe' added successfully with index 1."),
    (["Kelvin Klein", "0553488789", "kelvinklein@gmail.com"], "Contact 'Kelvin Klein' added successfully with index 1.")
])
...
@pytest.mark.parametrize("index, new_values, expected_output", [
    ("1", ["New Name", "0550000000", "newname@example.com"], "Contact with index 1 updated successfully."),
    ("1", ["", "0550000000", ""], "Contact with index 1 updated successfully."),
    ("3", ["", "", ""], "Contact with index 3 not found.")
])
def test_edit_contact(contact_manager, sample_contacts, index, new_values, expected_output, capsys):
    contact_manager.contacts = sample_contacts
...
def test_delete_contact(contact_manager, sample_contacts, index, expected_output, capsys):
